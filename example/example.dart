...
class VideoStoryEditorExample extends StatefulWidget {
  // final User? user;
  const VideoStoryEditorExample({super.key});

  @override
  State<VideoStoryEditorExample> createState() => _VideoStoryEditorExampleState();
}

class _VideoStoryEditorExampleState extends State<VideoStoryEditorExample> with SingleTickerProviderStateMixin {
