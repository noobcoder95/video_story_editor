...
class VideoStoryEditor extends StatefulWidget {
  ...
  final VideoStoryEditorController controller; // Custom controller for managing editor state.
  final bool? trimVideoOnAdjust; // Flag to determine if video should be trimmed when adjusted.
  const VideoStoryEditor(
  ...
  @override
  State<VideoStoryEditor> createState() => _VideoStoryEditorState();
}

class _VideoStoryEditorState extends State<VideoStoryEditor> {
              ...
              return ValueListenableBuilder(
                ...
                builder: (BuildContext context, StoryEditingModes mode, Widget? child) {
                  return PopScope(
                    ...
                    onPopInvokedWithResult: (isSystemPop, v) {
                      // Controlling state
