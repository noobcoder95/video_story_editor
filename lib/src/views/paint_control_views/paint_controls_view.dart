...
import 'package:video_story_editor/src/models/simple_sketecher.dart';
import 'package:video_story_editor/src/models/stroke.dart';
import 'package:video_story_editor/src/widgets/hue_color_picker_slider.dart';
...
class PaintControlsView extends StatefulWidget {
  ...
  final VideoStoryEditorController controller; // Controller for managing editing state.
  ...
  bottomIcon(IconData icon, {VoidCallback? onTap, bool? isSelected}) {
    return GestureDetector(
      ...
      child: Container(
        width: 40,
        height: 40,
        decoration: BoxDecoration(borderRadius: BorderRadius.circular(20), color: Colors.white.withValues(alpha: .2), border: isSelected == true ? Border.all(width: 1, color: Colors.white) : null),
        child: Icon(
          icon,
          size: 30,
          color: Colors.white,
